...
public class MessagingActivity extends BaseActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			Intent i=getIntent();
			mTxtRecipient.setText(i.getStringExtra("Name"));
	...
	private void sendMessage() {
		...
		if (recipient.isEmpty()) {
			Toast.makeText(this, "No recipient added", Toast.LENGTH_SHORT)
					.show();
			return;
		}
		if (textBody.isEmpty()) {
	...
	public void onMessageFailed(MessageClient client, Message message,
		...
		sb.append("Sending failed: ").append(
				failureInfo.getSinchError().getMessage());
